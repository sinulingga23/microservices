...
func (c *productClient) HandleDeductQtty(ctx context.Context, in *DeductQttyRequest, opts ...grpc.CallOption) (*base.BaseResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/product.Product/HandleDeductQtty", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Product_HandleDeductQtty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeductQttyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServer).HandleDeductQtty(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/product.Product/HandleDeductQtty",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServer).HandleDeductQtty(ctx, req.(*DeductQttyRequest))
	}
